...
final class Module
{
    ...
    public static function Define()
    {
        return array(
            ...
            self::ZVAL_ASSIGN_ARRAY_ZVAL_ELEMENT => array(Zval::zval('*'), array(Zval::zval('*'), Zval::zval('*'), Zval::zval('*'))),
            ...
            self::ZVAL_ASSIGN_STRING => array(Zval::zval('*'), array(Zval::zval('*'), Base::int(), Base::char('*'))),
            self::ZVAL_ASSIGN_ZVAL => array(Zval::zval('*'), array(Zval::zval('*'), Zval::zval('*'))),
            self::ZVAL_ASSIGN_CONCAT_STRING => array(Zval::zval('*'), array(Zval::zval('*'), Base::int(), Base::char('*'))),
            self::ZVAL_ASSIGN_CONCAT_ZVAL => array(Zval::zval('*'), array(Zval::zval('*'), Zval::zval('*'))),
            self::ZVAL_ASSIGN_REF => array(Zval::zval('*'), array(Zval::zval('*'))),
            ...
            self::ZVAL_ITERATE_CURRENT_VALUE => array(Zval::zval('*'), array(Base::void('*'))),
            self::ZVAL_ITERATE_IS_END => array(Base::int(), array(Base::void('*'))),
            self::ZVAL_ITERATE_NEXT => array(Base::void(), array(Base::void('*'))),
